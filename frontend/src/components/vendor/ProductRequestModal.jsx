...
const ProductRequestModal = ({ isOpen, onClose, url, currentBalance, onRequestSuccess }) => {
    ...
    const checkPendingRequest = async () => {
        ...
        try {
            const response = await fetch(`${url}/api/product-requests/current-pending`, {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${url}/api/product-requests/submit`, {
                method: 'POST',
                headers: {
                ...
                <ModalBody>
                    <VStack spacing={4}>
                        {isCheckingPending ? (
                            ...
                            <>
                                <Text>Your request will be reviewed and processed within 24 hours.</Text>
